...
App.controller('PersonListController', function ($scope) {
    ...
    $scope.showPanel = null; // don't display Person Details in Panel by default
    ...
    $scope.selectPerson = function (index, person) {
        ...
        $scope.selectedPerson = person; // get access to selected person details to display inside Details Panel on the right
        $scope.showPanel = true;
    };

    $scope.sensitiveSearch = function(person) {

        // if something entered into search
        if ($scope.search) {
